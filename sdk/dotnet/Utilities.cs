...
namespace RunpodInfra.Runpod
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/runpod/pulumi-runpod-native";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("RunpodInfra.Runpod.version.txt");
    ...
    internal sealed class RunpodResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public RunpodResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
