...
type Template struct {
	...
	Env                     EnvironmentVariableInputArrayOutput `pulumi:"env"`
	...
	VolumeMountPath         pulumi.StringOutput                 `pulumi:"volumeMountPath"`
}
...
func NewTemplate(ctx *pulumi.Context,
	...
	if args.VolumeMountPath == nil {
		return nil, errors.New("invalid value for required argument 'VolumeMountPath'")
	}
...
type TemplateArgs struct {
	...
	Env                     EnvironmentVariableInputArrayInput
	...
	VolumeMountPath         pulumi.StringInput
}
...
func (o TemplateOutput) Category() pulumi.StringOutput {
	return o.ApplyT(func(v *Template) pulumi.StringOutput { return v.Category }).(pulumi.StringOutput)
}

func (o TemplateOutput) Config() pulumi.MapOutput {
	return o.ApplyT(func(v *Template) pulumi.MapOutput { return v.Config }).(pulumi.MapOutput)
}
...
func (o TemplateOutput) Env() EnvironmentVariableInputArrayOutput {
	return o.ApplyT(func(v *Template) EnvironmentVariableInputArrayOutput { return v.Env }).(EnvironmentVariableInputArrayOutput)
}

func (o TemplateOutput) Id() pulumi.StringOutput {
	return o.ApplyT(func(v *Template) pulumi.StringOutput { return v.Id }).(pulumi.StringOutput)
}
...
func (o TemplateOutput) VolumeMountPath() pulumi.StringOutput {
	return o.ApplyT(func(v *Template) pulumi.StringOutput { return v.VolumeMountPath }).(pulumi.StringOutput)
}
