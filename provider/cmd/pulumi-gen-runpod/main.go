...
import (
	...
	runpod "github.com/runpod/pulumi-runpod-native/provider"
)
...
func main() {
	...
	var version string
	flag.StringVar(&version, "version", runpod.Version, "the provider version to record in the generated code")
